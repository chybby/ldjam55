...
@export var drop_audio_stream: AudioStream

@onready var pick_up_audio_player: AudioStreamPlayer = $PickUpAudioPlayer
@onready var drop_audio_player: AudioStreamPlayer = $DropAudioPlayer


func _ready() -> void:
    if pick_up_audio_stream != null:
        pick_up_audio_player.stream = pick_up_audio_stream
    if drop_audio_stream != null:
        drop_audio_player.stream = drop_audio_stream
...
func drop() -> void:
    ...
    if drop_audio_player.stream != null:
